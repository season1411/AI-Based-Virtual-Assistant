...
extracted_time = open('C:\\Users\\a\\PycharmProjects\\AIProject1\\Data.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\Users\\a\\PycharmProjects\\AIProject1\\Data.txt",'r+')
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            print("Wake Up Mam , It's Time To Work .")
            playsound("C:\\Users\\a\\PycharmProjects\\AIProject1\\Sounds\\1.mp3")
